...
class TerminalWidget(HelpGroupBox):
    ...
    COMMUNICATION_MESSAGE_TEXT_COLORS = {
        "[TX] ": "#B2FF59",
        "[RX] ": "#00E676",
    }
    ...
    def append_message(self, created_at: float, level_name: str, message: str) -> None:
        ...
        for message_line in message_lines:
            ...
            for prefix, communication_text_color in self.COMMUNICATION_MESSAGE_TEXT_COLORS.items():
                if message_line.startswith(prefix):
                    text_color = communication_text_color
                    break
